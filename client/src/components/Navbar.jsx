      ...
      <div>
        <div class='navPc'>
            <div class="d-flex gap-5 mx-5">
                <p class='fw-bold' style={{cursor:'pointer'}} onClick={()=>navigate('/car')}>Car</p>
        ...
        <div class='navMobile'>
          ...
          />
            ...
            <div class="offcanvas-body" style={{background:'#e3f2fd'}}>
              ...
              <p class='fw-bold' style={{cursor:'pointer'}} onClick={()=>navigate('/car')} data-bs-dismiss="offcanvas" aria-label="Close">Car</p>
